...
export function snapshotFromRow(row: any): WeeklySnapshot {
  return {
    ...
    constructionMaxed: row.construction_maxed ?? false,
    construction2Maxed: row.construction_2_maxed ?? false,
    researchMaxed: row.research_maxed ?? false,
...
export function snapshotToRow(
  ...
  return {
    ...
    construction_maxed: snapshot.constructionMaxed ?? false,
    construction_2_maxed: snapshot.construction2Maxed ?? false,
    research_maxed: snapshot.researchMaxed ?? false,
